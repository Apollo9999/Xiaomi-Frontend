        ...
        <>
          <div className='max-w-7xl mx-auto'>
            ...
            <div className='relative flex items-center justify-between h-16'>
              ...
              <div className='flex-1 flex items-center justify-center sm:items-stretch sm:justify-start text-orange'>
                <div className='flex-shrink-0 flex items-center cursor-pointer'>
                  <Link href='/'>
                    <h1
                      className='block lg:hidden h-8 w-auto font-bold text-2xl '
                      alt='Mi.Biz'>
                      Mi<span className=' text-blueish'>.</span>Biz
                    </h1>
                  </Link>
                  <Link href='/'>
                    <h1
                  ...
                  <div className=' flex flex-row'>
                    <div className='opacity-0 lg:opacity-100 mr-5'>
                      <button
                        ...
                        className='bg-orange hover:scale-95 shadow-lg cursor-pointer hover:brightness-125 rounded-xl lg:px-10 lg:py-3 p-3 text-white font-semibold lg:text-2xl text-xl text-center'>
                        About
                      </button>
                    </div>
                  </div>
